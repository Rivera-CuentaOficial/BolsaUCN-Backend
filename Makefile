...
.PHONY: help db-restart watch docker-create docker-start docker-stop
...
# 4) Iniciar contenedor PostgreSQL existente
docker-start:
	@echo "Iniciando contenedor PostgreSQL: $(CONTAINER_NAME)"
	docker start $(CONTAINER_NAME)

# 5) Detener contenedor PostgreSQL
docker-stop:
