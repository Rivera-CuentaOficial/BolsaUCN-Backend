...
namespace bolsafeucn_back.src.Application.Services.Interfaces
{
    public interface IDocumentStorageProvider
    {
        ...
        Task<bool> CVExistsAsync(GeneralUser generalUser);
    }
}